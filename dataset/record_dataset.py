...
class AugmentRecordDatasetWithLabelNum(BaseMXDataset):
    def __init__(self,
                 root_dir,
                 transform=None,
                 low_res_augmentation_prob=0.0,
        ...
        super(AugmentRecordDatasetWithLabelNum, self).__init__(root_dir,
                                                   swap_color_channel=swap_color_channel,
                                                   )
        self.augmenter = Augmenter(crop_augmentation_prob, photometric_augmentation_prob, low_res_augmentation_prob)
        self.transform = transform
        ...
        self.value_counts = self.record_info['label'].value_counts()
        self.sample_len = len(self.record_info)
    ...
    def __getitem__(self, index):
        ...
        return sample, (target,self.value_counts[target]/self.sample_len)

class AugmentRecordDatasetWithIdx(BaseMXDataset):
    def __init__(self,
                 root_dir,
                 transform=None,
                 low_res_augmentation_prob=0.0,
        ...
        super(AugmentRecordDatasetWithIdx, self).__init__(root_dir,
                                                   swap_color_channel=swap_color_channel,
                                                   )
        self.augmenter = Augmenter(crop_augmentation_prob, photometric_augmentation_prob, low_res_augmentation_prob)
        self.transform = transform
...
class AugmentRecordDatasetWithPickle(BaseMXDataset):
    def __init__(self,
                 root_dir,
                 transform=None,
                 low_res_augmentation_prob=0.0,
        ...
        super(AugmentRecordDatasetWithPickle, self).__init__(root_dir,
                                                   swap_color_channel=swap_color_channel,
                                                   )
        self.augmenter = Augmenter(crop_augmentation_prob, photometric_augmentation_prob, low_res_augmentation_prob)
        self.transform = transform
        ...
        with open(file='/home/taes/AdaFace/race_ori_idx_list.pickle', mode='rb') as f:
            self.imgidx = pickle.load(f)
